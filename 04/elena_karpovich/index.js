...
// function ShopProduct(title, price, length) {
//     this.title = title;
//     this.price = price;
//     this.length = length;
//     this.getInfo = function () {
//         return "Product: " + this.title + "," + " price: " + this.price + "," + " length: " + this.length;
//     }
// }

// let CDProduct = ShopProduct;
// let BookProduct = ShopProduct;
...
function BookProduct(title, price, pages) {
    ...
    this.pages = pages;
    this.getInfo = function () {
        return "Product: " + this.title + "," + " price: " + this.price + "," + " pages: " + this.pages;
    }
}
